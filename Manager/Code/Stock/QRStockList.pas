...
procedure TFQRStockList.QRLabel14Print(sender: TObject; var Value: string);
begin
  Value := MSG_ORGANIZATION + Value;
end;

procedure TFQRStockList.QRExpr3Print(sender: TObject; var Value: string);
begin
  Value := SmallTOBig(StrToFloat(Value));
end;

procedure TFQRStockList.QRepPreview(Sender: TObject);
begin
