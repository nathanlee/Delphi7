...
var
  UnStockParallFrm: TUnStockParallFrm;
...
procedure TUnStockParallFrm.FormCreate(Sender: TObject);
var
  Year, Month, Day: Word;
  I: integer;
begin
...
procedure TUnStockParallFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  UnStockParallFrm := nil;
  Action := caFree;
end;

procedure TUnStockParallFrm.SBExtClick(Sender: TObject);
begin
  Close;
end;

procedure TUnStockParallFrm.SBPrnClick(Sender: TObject);
begin
...
procedure TUnStockParallFrm.SBAddClick(Sender: TObject);
var
  I, lEnd, lStart: integer;
begin
  if not OperRights(SYS_OPR_ID, '02014', SYS_SELECT) then
  begin
    ShowMessage(MSG_USE_LIMITED);
    Exit;
  end;
...
procedure TUnStockParallFrm.SBCustClick(Sender: TObject);
begin
...
procedure TUnStockParallFrm.CBXTypeChange(Sender: TObject);
var
...
procedure TUnStockParallFrm.SaleParallAfterScroll(DataSet: TDataSet);
var
  i: integer;
begin
  Chart1.Series[0].Clear;
...
procedure TUnStockParallFrm.SBExpClick(Sender: TObject);
begin
  if not OperRights(SYS_OPR_ID, '02014', SYS_PRINT) then
  begin
    ShowMessage(MSG_USE_LIMITED);
