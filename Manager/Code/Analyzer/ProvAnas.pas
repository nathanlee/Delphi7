...
procedure TProvAnasFrm.FormCreate(Sender: TObject);
var
  Year, Month, Day: Word;
  I: integer;
begin
...
procedure TProvAnasFrm.FormClose(Sender: TObject;
...
procedure TProvAnasFrm.CBXTypeChange(Sender: TObject);
var
...
procedure TProvAnasFrm.SBCustClick(Sender: TObject);
begin
...
procedure TProvAnasFrm.btnSBAdd1Click(Sender: TObject);
begin
  if not OperRights(SYS_OPR_ID, '02018', SYS_SELECT) then
  begin
...
procedure TProvAnasFrm.SaleStat;
var
...
procedure TProvAnasFrm.Page0Change(Sender: TObject);
var
  vp, I: integer;
  Bar: TBarSeries;
  ...
  begin
    ...
    case cbxSType0.ItemIndex of
      ...
      3, 4: {饼图}
        begin
          Chart0.Title.Text.Clear;
          Chart0.Title.Text.Add('商品品牌和类别采购饼图');
...
procedure TProvAnasFrm.CbxSType0Change(Sender: TObject);
begin
  if cbxsType0.ItemIndex <> 2 then
    with cbxMonth0 do
    begin
...
procedure TProvAnasFrm.Grid0TitleBtnClick(Sender: TObject; ACol: Integer;
  Column: TColumnEh);
begin
  GridTitleBtnClickSort(Sender, Column);
end;

procedure TProvAnasFrm.SaleTrendStat;
var
...
procedure TProvAnasFrm.Page1Change(Sender: TObject);
var
  I: integer;
begin
...
procedure TProvAnasFrm.SaleAlarmStat;
var
  I, lEnd, lStart: integer;
begin
...
procedure TProvAnasFrm.SaleParallStat;
var
  I, lEnd, lStart: integer;
begin
...
procedure TProvAnasFrm.SaleParallAfterScroll(DataSet: TDataSet);
var
  i: integer;
begin
  Chart2.Series[0].Clear;
...
procedure TProvAnasFrm.unSaleStat;
var
  V, I, lEnd, lStart: integer;
begin
  {取消了按区域统计，所以做这个处理}
...
procedure TProvAnasFrm.Page2Change(Sender: TObject);
var
  vp, I: integer;
  Bar: TBarSeries;
  FastLine: TFastLineSeries;
  ...
  begin
    ...
    case cbxSType2.ItemIndex of
      ...
      3, 4: {饼图}
        begin
          Chart0.Title.Text.Clear;
          Chart0.Title.Text.Add('商品品牌和类别采购退货饼图');
          Pie := TPieSeries.Create(nil);
...
procedure TProvAnasFrm.cbxSType2Change(Sender: TObject);
begin
...
procedure TProvAnasFrm.UnSaleTrendStat;
var
  I, lEnd, lStart: integer;
begin
  ShowHide(MSG_PROCESS_DATA);
...
procedure TProvAnasFrm.Page3Change(Sender: TObject);
var
  I: integer;
begin
...
procedure TProvAnasFrm.UnSaleAlarmStat;
var
  I, lEnd, lStart: integer;
begin
...
procedure TProvAnasFrm.unSaleParallStat;
var
  I, lEnd, lStart: integer;
begin
...
procedure TProvAnasFrm.UnSaleParallAfterScroll(DataSet: TDataSet);
var
  i: integer;
begin
  Chart5.Series[0].Clear;
...
procedure TProvAnasFrm.btnSBExt1Click(Sender: TObject);
begin
  Close;
end;

procedure TProvAnasFrm.btnSBPrn1Click(Sender: TObject);
begin
  if not OperRights(SYS_OPR_ID, '02018', SYS_PRINT) then
  begin
    ShowMessage(MSG_USE_LIMITED);
    Exit;
  end;
...
procedure TProvAnasFrm.SBExpClick(Sender: TObject);
var
  Grid: TDBGridEH;
begin
  if not OperRights(SYS_OPR_ID, '02018', SYS_PRINT) then
