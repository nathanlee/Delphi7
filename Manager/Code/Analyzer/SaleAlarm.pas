...
procedure TSaleAlarmFrm.FormClose(Sender: TObject;
...
procedure TSaleAlarmFrm.FormCreate(Sender: TObject);
var
  Year, Month, Day: Word;
  I: integer;
begin
...
procedure TSaleAlarmFrm.CBXTypeChange(Sender: TObject);
var
...
procedure TSaleAlarmFrm.SBTypeClick(Sender: TObject);
begin
...
procedure TSaleAlarmFrm.SBAddClick(Sender: TObject);
var
  I, lEnd, lStart: integer;
begin
  if not OperRights(SYS_OPR_ID, '02010', SYS_SELECT) then
  begin
...
procedure TSaleAlarmFrm.SBPrnClick(Sender: TObject);
begin
  if not OperRights(SYS_OPR_ID, '02010', SYS_PRINT) then
  begin
    ShowMessage(MSG_USE_LIMITED);
    Exit;
  end;
...
procedure TSaleAlarmFrm.SBExtClick(Sender: TObject);
begin
  Close;
end;

procedure TSaleAlarmFrm.GridTitleBtnClick(Sender: TObject; ACol: Integer;
  Column: TColumnEh);
begin
  GridTitleBtnClickSort(Sender, Column);
end;

procedure TSaleAlarmFrm.SBExpClick(Sender: TObject);
begin
  if not OperRights(SYS_OPR_ID, '02010', SYS_PRINT) then
  begin
    ShowMessage(MSG_USE_LIMITED);
